...
export function bindAppEvents(app) {
    ...
    function renderPaymentSummary() {
        ...
        elements.accountSupportSummary.textContent = hasSupported
            ? `Поддержка проекта ${support.lastDonationAt ? new Date(support.lastDonationAt).toLocaleDateString('ru-RU') : 'без даты'}. Спасибо, что помогаете проекту. Оплата проходит на защищённой стороне YooKassa.`
            : 'Оплата проходит на защищённой стороне YooKassa. Спасибо, что поддерживаете проект.';
